...
//#include "sector.h" //korkoros dependencia lenne, ugyhogy inkabb forward
// declarationnel vezetjuk be a Sector-t es a sectors-t (ld.
...
struct Parent
{
    board a;
    signed char wms;
    Parent(board a, signed char wms)
        : a(a)
        , wms(wms)
    { }
    Parent() { }
...
const int max_parents = 2048; // std-ben 3,3,0,0-ban vannak 900 koruli ertekek,
                              // tovabba laskerben lattunk 1026-osat, valamint
                              // 1500 koruli felulbecslesunk volt
