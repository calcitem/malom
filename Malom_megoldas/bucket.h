...
// A nagy bucket fajlok kozott lehetnek lyukak (amit a big_bucket_reader
// elabsztrahal olvasaskor), a kicsik kozott nem.
...
struct small_bucket_elem
{
    ...
    small_bucket_elem() { }
    small_bucket_elem(short_id sid, int hash)
        : sid {sid}
        , hash {hash}
    { }
    ...
    bool operator==(const small_bucket_elem &o) const
    {
        return sid == o.sid && hash == o.hash;
    }
    bool operator!=(const small_bucket_elem &o) const
    {
        return !((*this) == o);
...
struct big_bucket_elem : small_bucket_elem
{
    ...
    bool operator==(const big_bucket_elem &o) const
    {
        return sid == o.sid && hash == o.hash && key2 == o.key2;
    }
...
private:
    void init(); // ez azert van kulon, mert csak akkor akarjuk letrehozni a
                 // fajlt, ha tenyleg irunk bele
public:
...
struct queue_elem
{
    ...
    static const queue_elem max; // ezt akkor kapjuk, ha mar ures a queue
                                 // (strazsa elem)
    bool operator==(const queue_elem &o) const
    {
        return sid == o.sid && hash == o.hash && val == o.val;
    }
};
...
// reads big buckets
class bucket_reader_mgr
{ //(az adattagok sorrendje fontos)
