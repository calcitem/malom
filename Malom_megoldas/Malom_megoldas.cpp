...
void exp()
{
    ...
    //		tmp+=hash->hash(a); //ez nem a parent-oket hash-eli egyelore,
    // mert ahhoz kene a masik sector hash fuggvenyet is inicializalni (persze
    // ez
    // igy a cache-ek miatt nem igazan jol meri a sebesseget)
    // }
    // cout<<tmp<<endl;
