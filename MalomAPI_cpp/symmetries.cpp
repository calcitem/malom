...
int (*slow[16])(int) = {rot90, rot180, rot270, tt_fuggoleges, tt_vizszintes, tt_bslash, tt_slash,
						swap, swap_rot90, swap_rot180, swap_rot270, swap_tt_fuggoleges, swap_tt_vizszintes, swap_tt_bslash, swap_tt_slash,
						id};
...
//int table1[16][patc], table2[16][patc], table3[16][patc], table4[16][patc]; //osszesen 16 KB
//int table[patn][16][patc];
...
board sym48(int op, board a){
	return sym24(op, a&mask24) | (sym24(op, a>>24)<<24); //| (a&(1LL<<48)); //ez talan nem kell ide, ugye?
}
