...
eval_elem_sym::eval_elem_sym(cas c,int x):c(c),x(x){}
bool eval_elem_sym::operator==(const eval_elem_sym &o) const {return c==o.c && x==o.x;}
eval_elem_sym::eval_elem_sym(const eval_elem &o): c((cas)o.c), x(o.x) {}

eval_elem::eval_elem(cas c,int x):c(c),x(x){}
bool eval_elem::operator==(const eval_elem &o) const {return c==o.c && x==o.x;}
eval_elem::eval_elem(const eval_elem_sym &o): c((cas)o.c), x(o.x) {assert(o.c!=eval_elem_sym::sym);}
...
eval_elem2::eval_elem2(val v) : key1(v.key1), key2(v.key2) {}
eval_elem2::eval_elem2(int c) : key1(0), key2(c) {}
...
eval_elem_sym2::eval_elem_sym2(val v) : key1(v.key1), key2(v.key2) {}
eval_elem_sym2::eval_elem_sym2(int c) : key1(0), key2(c) {}
eval_elem_sym2::eval_elem_sym2(sec_val key1, int key2) : key1{ key1 }, key2{ key2 } {}
...
eval_elem2::eval_elem2(const eval_elem_sym2 &o) : key1(o.key1), key2(o.key2) {
	assert(o.cas() != eval_elem_sym2::Sym);
}

eval_elem_sym2::eval_elem_sym2(const eval_elem2 &o) : key1(o.key1), key2(o.key2) {}



eval_elem2 eval_elem2::corr(int corr){
	sec_val	new_key1 = key1 + corr;
	return eval_elem2{ new_key1, sign((long long)new_key1 * key1) * key2 }; //magic, don't touch!
}
...
bool eval_elem2::operator>(const eval_elem2 &b) const { auto &a = *this;  return b < a; }
bool eval_elem2::operator<=(const eval_elem2 &b) const { auto &a = *this;  return !(a > b); }
bool eval_elem2::operator>=(const eval_elem2 &b) const { auto &a = *this;  return !(a < b); }
