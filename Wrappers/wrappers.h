...
value struct WID
{
    ...
    // W.ToString()+"_"+B.ToString()+"_"+WF.ToString()+"_"+BF.ToString();}
    virtual String ^ ToString() override
    {
        string str = this->tonat().to_string();
        return gcnew String(str.c_str());
    }
    // String^ FileName(){return gcnew
    // String(::id(W,B,WF,BF).file_name().c_str());}
...
public
value struct gui_eval_elem2 : IComparable<gui_eval_elem2>
{
private:
    ...
    eval_elem2 to_eval_elem2() { return eval_elem2 {key1, key2}; }
...
public:
    ...
    static bool operator<(gui_eval_elem2 a, gui_eval_elem2 b)
    {
    ...
    {
        return gui_eval_elem2 {abs_min_value() -
                                   (s ? s->sval() : virt_unique_sec_val()),
                               0, s ? s->s : nullptr};
    }
    ...
    { // vigyazat: csak KLE-ben mukodik jol, mert ugye ahhoz, hogy jol mukodjon,
      ...
      // vonunk ki
        ...
        return gui_eval_elem2 {::virt_loss_val - virt_unique_sec_val(), 0,
                               nullptr};
    }
    ...
    bool is_ntreks_or_89_98(){
            ...
            return akey1 == 0 || akey1 == sec_vals[::id{ 8, 9, 0, 0 }] || akey1
    == sec_vals[::id{ 9, 8, 0, 0 }];
    }
    bool is_loss(){
...
public
ref class Init abstract sealed
{
public:
...
public
ref class Constants abstract sealed
{
public:
...
{
public:
    static String ^ toclp(board a) { return gcnew String(::toclp(a)); }
};
} // namespace Wrappers
